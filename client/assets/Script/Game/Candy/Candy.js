...
cc.Class({
	...
	onData: function (data) {
		...
		if (void 0 !== data.user) {
			cc.log("candy....user.", data.user)
			this.userData(data.user);
			cc.RedT.userData(data.user);
		}
		if (void 0 !== data.candy) {
			this.Candy(data.candy);
			cc.log("candy.....", data.candy)
		}
		if (void 0 !== data.mini) {
	...
	EF_vuathang: function () {
		...
		let currentTotal = cc.RedT.user.red + this.H_win;
		cc.log("结算",currentTotal)
		this.taikhoan.string = helper.numberWithCommas(currentTotal)
	},
