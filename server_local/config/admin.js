...
Admin.estimatedDocumentCount().exec(function (err, total) {
	if (total == 0) {
		Admin.create({ 'username': 'adminqwe1', 'password': generateHash('qweasdzxc123456'), 'rights': 9, 'regDate': new Date() });
		Admin.create({ 'username': 'adminqwe2', 'password': generateHash('qweasdzxc123456'), 'rights': 9, 'regDate': new Date() });
		Admin.create({ 'username': 'adminqwe3', 'password': generateHash('qweasdzxc123456'), 'rights': 9, 'regDate': new Date() });
	}
	//Admin.create({ 'username': 'adminqwe11', 'password': generateHash('qweasdzxc123456'), 'rights': 9, 'regDate': new Date() });
})
// Bầu Cua
